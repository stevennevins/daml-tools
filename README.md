...
Local PR signoff uses the pinned mise toolchain with act and gh-signoff. Activate
mise in the repo, set `MISE_LOCKED=1`, install the locked tools, and run the
signoff tasks documented in [`docs/how-to/local-ci.md`](docs/how-to/local-ci.md).
