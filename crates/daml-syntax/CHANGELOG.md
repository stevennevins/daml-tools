...
## [0.9.1](https://github.com/stevennevins/daml-tools/compare/daml-syntax-v0.9.0...daml-syntax-v0.9.1) - 2026-06-27

### Other

- updated the following local packages: daml-parser

## [0.9.0](https://github.com/stevennevins/daml-tools/compare/daml-syntax-v0.8.1...daml-syntax-v0.9.0) - 2026-06-27

### Changed

- *(api)* [**breaking**] update public `daml-parser` dependency to 0.10.0.
